# Feb 1, 2021
# This is the main sim but with the ability to choose one message in an MSO collision
...
def main():
    ...
    #     ax.scatter(north_vals, east_vals, c="gray", s=point_size)
    #
    # if plot_collisions:
    #     collisions_2d = []
    #     legend_labels = []
    ...
    #             if len(overall_collision_objects[i][j]["vehicles_involved"]) > 0:
    #                 legend_labels.append(legend_labels.append("Collision {}".format(collision_number + 1)))
    #                 collision_number += 1
    ...
    #                 if k == 0:
    #                     collisions_2d.append(ax.scatter(p.vehicle_positions[vehicle_id][i][0],
