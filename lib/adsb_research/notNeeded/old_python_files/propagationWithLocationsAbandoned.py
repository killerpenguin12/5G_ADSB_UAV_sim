...
from flightPaths.openLogFiles import vehiclePositions
...
all_vehicle_positions = vehiclePositions.copy()
...
for i in range(p.num_vehicles):
    ...
    uas = vehicle(all_vehicle_positions[i])
    vehicles.append(uas)
