            ...
            for k in range(self.vehicles[j].vehicle_identifier + 1, self.vehicles[j].vehicle_identifier + self.num_vehicles):
                ...
                if received_power >= -90.0:  # Do some random draw failures
                    ...
                    if free < 0.99:
                        ...
                        self.visibilityList['chance'].append(k)
                    ...
                    self.visibilityList['MTL'].append(k)
                #print("3.4")
                ...
                ########################################################################################
                #print("3.43")
                val = k % self.num_vehicles
                #print(k%self.num_vehicles)
                #print("type val: ", type(val))
                #print("3.44")
                val2 = self.vehicles[k % self.num_vehicles].vehicle_identifier
                #print("type val: ", type(val2))
                #print("3.445")
                #print(distance)
                #print("type dist: ", type(distance))
                #print("Second")
                #(received_power)
                #print("type r_p: ", type(received_power))
                #print("Third")
                #print(meets_minimum_trigger_level)
                #print("type MTL: ", type(meets_minimum_trigger_level))
                #print("fourth")
                #########################################################################################3
                ...
                """transmission = {}
                try:
                    transmission = dict.fromkeys(['successfuldecode','distance','receivedpower','receiverID'])
                    #print("Here 1")
                    #print(transmission)
                    transmission['successfuldecode'] = bool(meets_minimum_trigger_level)
                    #print("Here 4")
                
                    transmission['distance'] =  float(distance)
                    #print("Here 2")

                
                    transmission['receivedpower'] = int(received_power)
                    #print("Here 3")
                    transmission['receiverID'] =  int(k % self.num_vehicles)
            ...
            for k in range(self.num_vehicles):  # for every vehicle
                ...
                if (mso_to_check < (mso - 9)) or (mso_to_check > (mso + 8)):
                    ...
                    if transmissions[0]["receivedpower"] >= p.receiver_min_trigger_level:
                        ...
                        if len(transmissions) < 2: #Coulton added this, not sure if its kosher
                            pass
